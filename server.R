...
function(input, output, session) {
  ...
  observeEvent(input$start_btn, {
    ...
    output$subtitle_s24 <- renderUI({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'epistemicUnc_PC' & input$eType_PTARG == 'aleatoricUnc_PTARG') {
        
        # Create div for Variable 1 statement
        div1 <- div(
          style = "text-align: center; font-size: 20px; font-weight: bold;",
          p(paste("PNC is an ",type_list[3], ", PC is a ", type_list[2], ", Target is a ",type_list[3]))
        )
    ...
    analysis_results_24 <- eventReactive(input$start_btn, {
      ...
      df <- data.frame("PNC" = PNC, "PC" = rep(PC, times = 50000), "PoF" = PoF)
    ...
    output$aleatoric_hist_s24 <- renderPlotly({
      ...
      fig <- fig %>% add_histogram(x = ~analysis_results_24()[analysis_results_24()$PC == input$PF_C_lower,"IRR"], name = "PC lower")
      fig <- fig %>% add_histogram(x = ~analysis_results_24()[analysis_results_24()$PC == input$PF_C_upper,"IRR"], name = "PC upper")
    ...
    output$count_data_s24 <- renderPrint({
      ...
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'epistemicUnc_PC' & input$eType_PTARG == 'aleatoricUnc_PTARG') {
      value <- nrow(analysis_results_24())/100000
      paste("Fraction of simulated values included in the histogram", value)
    ...
    output$results_comment_s24 <- renderUI({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'epistemicUnc_PC' & input$eType_PTARG == 'aleatoricUnc_PTARG') {
        #Create div for Variable 3 statement
        div1 <- div(
          style = "text-align: center; font-size: 20px; font-weight: bold;",
          p(results_comment_list[24])
        )
    ...
    output$quantile_data_s24 <- renderTable({
      ...
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'epistemicUnc_PC' & input$eType_PTARG == 'aleatoricUnc_PTARG') {
        ...
        quantiles <- round(quantile(analysis_results_24()$IRR, probs = c(0.95, 0.975, 0.99, 0.999, 0.9999, 0.99999, 0.999999, 0.9999999, 0.99999999, 0.999999999)),digits = 9)
        quantile_table <- (data.frame(
          Quantile = names(quantiles),
          Value = as.numeric(quantiles)
        ))
    ...
    output$interval_data_s24 <- renderTable({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'epistemicUnc_PC' & input$eType_PTARG == 'aleatoricUnc_PTARG') {
        
        dflow <- analysis_results_24()[analysis_results_24()$PC == min(analysis_results_24()$PC),"IRR"]
        dfhigh <- analysis_results_24()[analysis_results_24()$PC == max(analysis_results_24()$PC),"IRR"]
        
        quantile_table <- data.frame("PC" = c(min(analysis_results_24()$PC),max(analysis_results_24()$PC)),
                                     "0.025" = c(quantile(dflow,0.025),quantile(dfhigh,0.025)),
                                     "0.975" = c(quantile(dflow,0.975),quantile(dfhigh,0.975))
        )
        return(quantile_table)
    ...
    output$ecdf_plot_s24 <- renderPlot({
    ...
    output$uncertainty_statements_s24 <- renderUI({
    ...
    output$summary_comment_s24 <- renderUI({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'epistemicUnc_PC' & input$eType_PTARG == 'aleatoricUnc_PTARG') {
        #Create div for Variable 3 statement
        div1 <- div(
          style = "text-align: center; font-size: 20px; font-weight: bold;",
          p(summary_comment_list[24])
        )
    ...
    output$recommendation_statement_s24 <- renderUI({
    ...
    output$subtitle_s25 <- renderUI({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'unknownUnc_PTARG') {
        
        # Create div for Variable 1 statement
        div1 <- div(
          style = "text-align: center; font-size: 20px; font-weight: bold;",
          p(paste("PNC is an ",type_list[3], ", PC is a ", type_list[3], ", Target is a ",type_list[1]))
        )
    ...
    analysis_results_25 <- eventReactive(input$start_btn, {
      ...
      df <- data.frame("PNC" = PNC, "PC" = PC, "PoF" = rep(PoF, times = 100000))
    ...
    output$aleatoric_hist_s25 <- renderPlotly({
      ...
      fig <- fig %>% add_histogram(x = ~analysis_results_25()$IRR, name = "PC is a Point Estimate")
    ...
    output$count_data_s25 <- renderPrint({
      ...
      value <- nrow(analysis_results_25())/100000
      paste("Fraction of simulated values included in the histogram", value)
    ...
    output$results_comment_s25 <- renderUI({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'unknownUnc_PTARG') {
        #Create div for Variable 3 statement
        div1 <- div(
          style = "text-align: center; font-size: 20px; font-weight: bold;",
          p(results_comment_list[25])
        )
    ...
    output$quantile_data_s25 <- renderTable({
      ...
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'unknownUnc_PTARG') {
        ...
        quantiles <- round(quantile(analysis_results_25()$IRR, probs = c(0.95, 0.975, 0.99, 0.999, 0.9999, 0.99999, 0.999999, 0.9999999, 0.99999999, 0.999999999)),digits = 9)
        quantile_table <- (data.frame(
          Quantile = names(quantiles),
          Value = as.numeric(quantiles)
        ))
    ...
    output$interval_data_s25 <- renderTable({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'unknownUnc_PTARG') {
        
        quantiles <- round(quantile(analysis_results_25()$IRR, probs = c(0.025, 0.975)),digits = 9)
        quantile_table <- (data.frame(
          Quantile = names(quantiles),
          Value = as.numeric(quantiles)
        ))
    ...
    output$ecdf_plot_s25 <- renderPlot({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'unknownUnc_PTARG') {
        
        fig <- ggplot(analysis_results_25(),aes(x = IRR))+
          stat_ecdf() +
          ggtitle("ECDF for IRR from Simulation (Cumulative Density Function)")
        fig
    ...
    output$uncertainty_statements_s25 <- renderUI({
    ...
    output$summary_comment_s25 <- renderUI({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'unknownUnc_PTARG') {
        #Create div for Variable 3 statement
        div1 <- div(
          style = "text-align: center; font-size: 20px; font-weight: bold;",
          p(summary_comment_list[25])
        )
    ...
    output$recommendation_statement_s25 <- renderUI({
    ...
    output$subtitle_s26 <- renderUI({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'epistemicUnc_PTARG') {
        
        # Create div for Variable 1 statement
        div1 <- div(
          style = "text-align: center; font-size: 20px; font-weight: bold;",
          p(paste("PNC is an ",type_list[3], ", PC is a ", type_list[3], ", Target is a ",type_list[2]))
        )
    ...
    analysis_results_26 <- eventReactive(input$start_btn, {
      ...
      df <- data.frame("PNC" = PNC, "PC" = PC, "PoF" = rep(PoF, times = 50000))
    ...
    output$aleatoric_hist_s26 <- renderPlotly({
      ...
      fig <- fig %>% add_histogram(x = ~analysis_results_26()[analysis_results_26()$PoF == input$PF_TARG_lower,"IRR"], name = "PoF lower")
      fig <- fig %>% add_histogram(x = ~analysis_results_26()[analysis_results_26()$PoF == input$PF_TARG_upper,"IRR"], name = "PoF upper")
    ...
    output$count_data_s26 <- renderPrint({
      ...
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'epistemicUnc_PTARG') {
      value <- nrow(analysis_results_26())/100000
      paste("Fraction of simulated values included in the histogram", value)
    ...
    output$results_comment_s26 <- renderUI({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'epistemicUnc_PTARG') {
        #Create div for Variable 3 statement
        div1 <- div(
          style = "text-align: center; font-size: 20px; font-weight: bold;",
          p(results_comment_list[26])
        )
    ...
    output$quantile_data_s26 <- renderTable({
      ...
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'epistemicUnc_PTARG') {
        ...
        quantiles <- round(quantile(analysis_results_26()$IRR, probs = c(0.95, 0.975, 0.99, 0.999, 0.9999, 0.99999, 0.999999, 0.9999999, 0.99999999, 0.999999999)),digits = 9)
        quantile_table <- (data.frame(
          Quantile = names(quantiles),
          Value = as.numeric(quantiles)
        ))
    ...
    output$interval_data_s26 <- renderTable({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'epistemicUnc_PTARG') {
        
        dflow <- analysis_results_26()[analysis_results_26()$PoF == min(analysis_results_26()$PoF),"IRR"]
        dfhigh <- analysis_results_26()[analysis_results_26()$PoF == max(analysis_results_26()$PoF),"IRR"]
        
        quantile_table <- data.frame("PoF" = c(min(analysis_results_26()$PoF),max(analysis_results_26()$PoF)),
                                     "0.025" = c(quantile(dflow,0.025),quantile(dfhigh,0.025)),
                                     "0.975" = c(quantile(dflow,0.975),quantile(dfhigh,0.975))
        )
        return(quantile_table)
    ...
    output$ecdf_plot_s26 <- renderPlot({
    ...
    output$uncertainty_statements_s26 <- renderUI({
    ...
    output$summary_comment_s26 <- renderUI({
      
      if(input$eType_PNC == 'aleatoricUnc_PNC' & input$eType_PC == 'aleatoricUnc_PC' & input$eType_PTARG == 'epistemicUnc_PTARG') {
        #Create div for Variable 3 statement
        div1 <- div(
          style = "text-align: center; font-size: 20px; font-weight: bold;",
          p(summary_comment_list[26])
        )
    ...
    output$recommendation_statement_s26 <- renderUI({
