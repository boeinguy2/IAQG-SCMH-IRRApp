...
function(input, output, session) {
  ...
  observeEvent(input$start_btn, {
    ...
    output$aleatoric_hist_s16 <- renderPlotly({
      ...
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s16()[aleatoric_data_s16()$PNC == input$PF_NC_lower,"IRR"], name = "PNC lower")
      
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s16()[aleatoric_data_s16()$PNC == input$PF_NC_upper,"IRR"], name = "PNC upper")
    ...
    output$count_data_s16 <- renderPrint({
      value <- nrow(aleatoric_data_s16())/100000
      paste("Fraction of simulated values included in the histogram", value)
    })
    ...
    output$quantile_data_s16 <- renderTable({
      quantiles <- round(quantile(aleatoric_data_s16()$IRR, probs = c(0.95, 0.975, 0.99, 0.999, 0.9999, 0.99999, 0.999999, 0.9999999, 0.99999999, 0.999999999)),digits = 9)
      quantile_table <- t(data.frame(
        Quantile = names(quantiles),
        Value = as.numeric(quantiles)
      ))
    ...
    output$aleatoric_hist_s20 <- renderPlotly({
      ...
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s20()[aleatoric_data_s20()$PoF == input$PF_TARG_lower,"IRR"], name = "Target lower")
      
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s20()[aleatoric_data_s20()$PoF == input$PF_TARG_upper,"IRR"], name = "Target upper")
    ...
    output$count_data_s20 <- renderPrint({
      value <- nrow(aleatoric_data_s20())/100000
      paste("Fraction of simulated values included in the histogram", value)
    })
    ...
    output$quantile_data_s20 <- renderTable({
      quantiles <- round(quantile(aleatoric_data_s20()$IRR, probs = c(0.95, 0.975, 0.99, 0.999, 0.9999, 0.99999, 0.999999, 0.9999999, 0.99999999, 0.999999999)),digits = 9)
      quantile_table <- t(data.frame(
        Quantile = names(quantiles),
        Value = as.numeric(quantiles)
      ))
    ...
    output$aleatoric_hist_s21 <- renderPlotly({
      ...
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s21()$IRR, name = "PC is a point estimate")
    ...
    output$count_data_s21 <- renderPrint({
      value <- nrow(aleatoric_data_s21())/100000
      paste("Fraction of simulated values included in the histogram", value)
    })
    ...
    output$quantile_data_s21 <- renderTable({
      quantiles <- round(quantile(aleatoric_data_s21()$IRR, probs = c(0.95, 0.975, 0.99, 0.999, 0.9999, 0.99999, 0.999999, 0.9999999, 0.99999999, 0.999999999)),digits = 9)
      quantile_table <- t(data.frame(
        Quantile = names(quantiles),
        Value = as.numeric(quantiles)
      ))
    ...
    output$aleatoric_hist_s22 <- renderPlotly({
      ...
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s22()[aleatoric_data_s22()$PC == input$PF_C_lower,"IRR"], name = "PC lower")
      
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s22()[aleatoric_data_s22()$PC == input$PF_C_upper,"IRR"], name = "PC upper")
    ...
    output$count_data_s22 <- renderPrint({
      value <- nrow(aleatoric_data_s22())/100000
      paste("Fraction of simulated values included in the histogram", value)
    })
    ...
    output$quantile_data_s22 <- renderTable({
      quantiles <- round(quantile(aleatoric_data_s22()$IRR, probs = c(0.95, 0.975, 0.99, 0.999, 0.9999, 0.99999, 0.999999, 0.9999999, 0.99999999, 0.999999999)),digits = 9)
      quantile_table <- t(data.frame(
        Quantile = names(quantiles),
        Value = as.numeric(quantiles)
      ))
    ...
    output$aleatoric_hist_s23 <- renderPlotly({
      ...
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s23()[aleatoric_data_s23()$PC == input$PF_C_lower & aleatoric_data_s23()$PoF == input$PF_TARG_lower,"IRR"], name = "PC lower & PoF lower")
      
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s23()[aleatoric_data_s23()$PC == input$PF_C_upper & aleatoric_data_s23()$PoF == input$PF_TARG_lower,"IRR"], name = "PC upper & PoF lower")
      
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s23()[aleatoric_data_s23()$PC == input$PF_C_lower & aleatoric_data_s23()$PoF == input$PF_TARG_upper,"IRR"], name = "PC lower & PoF upper")
      
      fig <- fig %>% add_histogram(x = ~aleatoric_data_s23()[aleatoric_data_s23()$PC == input$PF_C_upper & aleatoric_data_s23()$PoF == input$PF_TARG_upper,"IRR"], name = "PC upper & PoF upper")
    ...
    output$count_data_s23 <- renderPrint({
      value <- nrow(aleatoric_data_s23())/100000
      paste("Fraction of simulated values included in the histogram", value)
    })
    ...
    output$quantile_data_s23 <- renderTable({
      quantiles <- round(quantile(aleatoric_data_s23()$IRR, probs = c(0.95, 0.975, 0.99, 0.999, 0.9999, 0.99999, 0.999999, 0.9999999, 0.99999999, 0.999999999)),digits = 9)
      quantile_table <- t(data.frame(
        Quantile = names(quantiles),
        Value = as.numeric(quantiles)
      ))
